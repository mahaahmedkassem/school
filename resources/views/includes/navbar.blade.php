...
<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    <a href="{{route('index')}}" class="nav-item nav-link {{ request()->is('kider') ? 'active' : '' }} ">Home</a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle {{ request()->is('facilities', 'team', 'action', 'appointment', 'testimonial') ? 'active' : '' }}" data-bs-toggle="dropdown">Pages</a>
